...
const yandexUrl = 'https://yandex.ru/maps/org/barber_i_barbi/129691267585';
const services = [
...
export default function Home() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    setStatus({ text: 'Отправляем заявку…', kind: '' });
  ...
  const schema = {
    '@context': 'https://schema.org', '@type': 'BeautySalon', '@id': `${yandexUrl}#business`, name: 'Барбер и Барби', telephone: '+79876077896', url: 'https://barber-i-barbi.vercel.app', image: 'https://barber-i-barbi.vercel.app/images/haircut.webp',
    address: { '@type': 'PostalAddress', addressCountry: 'RU', addressRegion: 'Республика Башкортостан', addressLocality: 'Салават', streetAddress: 'бульвар Космонавтов, 13' },
    openingHoursSpecification: [{ '@type': 'OpeningHoursSpecification', dayOfWeek: ['Monday', 'Tuesday', 'Wednesday', 'Friday', 'Saturday', 'Sunday'], opens: '14:00', closes: '20:00' }],
    aggregateRating: { '@type': 'AggregateRating', ratingValue: '4.8', reviewCount: '33', bestRating: '5' }
  };

  return <main className="page">
    <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schema) }} />
    <section className="poster" id="top">
      <nav className="nav"><a href="#top">Барбер и Барби</a><div className="nav-links"><a href="#services">Услуги</a><a href="#works">Работы</a><a href="#booking">Запись</a></div></nav>
      <div className="hero"><p className="eyebrow">Парикмахерская · салон красоты · барбершоп</p><Image className="hero-art" src="/images/brand-illustration.png" alt="Фирменная иллюстрация Барбер и Барби" width={447} height={447} priority /><h1 className="display">Барбер и Барби</h1><p className="hero-sub">Стрижки, окрашивание и маникюр в Салавате — с вниманием к вашему образу и пожеланиям.</p><div className="actions"><a className="btn btn-primary" href="#booking">Записаться</a><a className="btn btn-secondary" href="tel:+79876077896">Позвонить</a></div><div className="facts"><span className="fact"><strong>★</strong> 4,8 на Яндекс.Картах</span><span className="fact">⌖ б-р Космонавтов, 13</span></div></div>
    </section>
